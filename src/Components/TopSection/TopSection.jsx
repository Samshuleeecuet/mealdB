...
const TopSection = () => {
    ...
    const fetchData = async () => {
        const response = await fetch(`https://api.example.com/data?search=${searchValue}`);
                ...
                <form className='w-3/4 mx-auto'>   
                    ...
                    <div class="relative">
                        ...
                        <input type="search" id="default-search" 
                         name="message" value={searchValue} onChange={(e) => setSearchValue(e.target.value)} class="block w-full p-4 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search any food" required/>
